...
<body>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="tab-content">
                    	<form action="" name="" id="order_form">
                        ...
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            <div class="row g-4">
                            	<%for
                            		(Map.Entry<String,Integer> e : breakfast.entrySet()){
                                    ...
                                    out.print("   <span id=\"item_name"+ind+"\">"+ e.getKey() +"</span> ");
                                    out.print("   <span class=\"text-primary\">$"+ e.getValue() +"</span> ");
		                            out.print("   </h4> ");
		                            out.print("   <div class=\"desc\"> ");
		                           	out.print("    <small class=\"fst-italic\">"+ desc.get(e.getKey()) +"</small> ");
		                            out.print("   </div> ");
		                            out.print("     <div class=\"mybtns\"> ");
		                            out.print("     	<p clas=\"qty\" id=\"qty"+ind+"\">0</p> ");
		                            out.print("    		<button class=\"plus mybtn\" id=\"plus"+ind+"\">+</button> ");
		                            out.print("   	    <button class=\"minus mybtn\" id=\"minus"+ind+"\">-</button> ");
		                            out.print("     </div> ");
		                            out.print("  </div> ");
		                            out.print(" </div> ");
		                            out.print(" </div> ");
                        ...
                        <div id="tab-2" class="tab-pane fade show p-0">
                            <div class="row g-4">
                               ...
                               <%for(Map.Entry<String,Integer> e : lunch.entrySet()){
		                            ...
		                            out.print("   </div> ");
		                            out.print("     <div class=\"mybtns\"> ");
		                            out.print("     	<p id=\"qty\">0</p> ");
		                            out.print("    		<button class=\"plus mybtn\">+</button> ");
		                            out.print("   	    <button class=\"minus mybtn\">-</button> ");
		                            out.print("     </div> ");
		                            out.print("  </div> ");
		                            out.print(" </div> ");
		                            out.print(" </div> ");
            ...
            <div class="checkout">
            <button type="button" id="submit_btn" class="btn btn-primary py-2 px-4">Checkout</button>
            </div>
        </div>
        <!-- Menu End -->
