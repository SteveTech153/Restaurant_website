...
<%@page import="java.sql.*,java.util.*" %>
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Footer Start -->
        <div class="container-fluid bg-dark text-light footer pt-5 mt-5 wow fadeIn footer" id="footer" data-wow-delay="0.1s">
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <h4 class="section-title ff-secondary text-start text-primary fw-normal mb-4">Contact</h4>
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i> <%= info.get("address") %> </p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i> <%= info.get("phone") %> </p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i> <%= info.get("email") %> </p>
                        <div class="d-flex pt-2">
                            <a class="btn btn-outline-light btn-social" href=" <%= info.get("twitter") %> "><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-outline-light btn-social" href=" <%= info.get("youtube") %> "><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-outline-light btn-social" href=" <%= info.get("facebook") %> "><i class="fab fa-youtube"></i></a>
                            <a class="btn btn-outline-light btn-social" href=" <%= info.get("linkedin") %> "><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#"> <%= info.get("restaurant_name") %> </a>, All Right Reserved. 
