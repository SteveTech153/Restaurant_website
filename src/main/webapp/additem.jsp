...
<body>
    ...
    <div class="container">
       <div class="result1">
			...
			stmt.setString(1,request.getParameter("name"));//1 specifies the first parameter in the query  
			stmt.setInt(2,Integer.parseInt( request.getParameter("price")));  
			int i=stmt.executeUpdate();  
			out.println("<h1 align=\"center\" style=\"padding-top:5%\">Item added to Menu !</h1> ");
       		}
       		catch(Exception e){ }  
